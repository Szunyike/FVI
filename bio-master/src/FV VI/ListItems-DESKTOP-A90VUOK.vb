...
Namespace Szunyi
	Public Class ListOf
		...
		Public Class SequenceList
            ...
            Public Property Type As String = MyConstants.BackGroundWork.Sequences
            ...
            End Sub
            Public Sub New(Seqs As List(Of Sequence), Name As String)
                Me.Sequences = Seqs
        ...
        Public Class ExtFeatureList
            ...
            ''' </summary>
            ''' <returns></returns>
            Public Shared Property Features As New List(Of ExtFeature)
            Public Shared Property FetauresByLocustag As New List(Of ExtFeature)
            Public Property SearchSetting As SettingForSearchInFeaturesAndQulifiers
            Public Property ShortFileName As String
            Public Property UniqueId As Integer
            Public ReadOnly Property Type = MyConstants.BackGroundWork.Features
            ...
            Public Sub New(SearchSetting As SettingForSearchInFeaturesAndQulifiers, SequenceLists As List(Of Szunyi.ListOf.SequenceList))
                ...
                Me.ShortFileName = Szunyi.Text.GetText(t, " ")
                Me.Seqs = Szunyi.Sequences.SequenceManinpulation.MergeSequenceList(SequenceLists)

            End Sub
            Public Sub New(SearchSetting As SettingForSearchInFeaturesAndQulifiers, OriginalSeqs As List(Of Bio.Sequence))
                Me.SearchSetting = SearchSetting
            ...
            Public Sub DoIt()
                Dim Result As List(Of ExtFeature) = Szunyi.GenBank.ExtFeatureManipulation.GetExtFeatures(Me.SearchSetting, Me.Seqs)
                Me.FetauresByLocustag = Result
                Me.Features = Result
                Me.FetauresByLocustag.Sort(Comparares.AllComparares.ByExtFeatureLocusTag)
                Me.Features.Sort(Comparares.AllComparares.ByExtFeatureLocation)

                Me.ShortFileName = Szunyi.Text.GetText(SearchSetting.SelectedFeatures, " ") & Me.ShortFileName
...
#End Region
        ...
        Public Class LocationList
            ...
            Public Property Type As String = MyConstants.BackGroundWork.Locations
            Public Property SubType As String
			Public Property Header As String
			Public Sub New(files As List(Of FileInfo))
				Me.ShortFileName = Szunyi.IO.Files.GetShortFileName(files)
				Me.Files = files
                Me.SubType = MyConstants.BackGroundWork.Locations
            End Sub
			Public Sub New(Features As ExtFeatureList)
				For Each Feat In Features.Features
					...
					Me.Locations.Add(x)
				Next
                Me.SubType = MyConstants.BackGroundWork.Features
            End Sub
			...
			For Each Qulifier In Qulifiers
                ...
                Else
                    If Me.Feature.Qualifiers.ContainsKey(Qulifier) = True Then
                        str.Append(Szunyi.Text.GetText(Me.Feature.Qualifiers(Qulifier), Separator)).Append(Separator)
                    Else
