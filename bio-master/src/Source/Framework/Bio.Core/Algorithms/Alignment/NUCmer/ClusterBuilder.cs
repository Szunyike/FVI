...
namespace Bio.Algorithms.Alignment
{
    ...
    public class ClusterBuilder : IClusterBuilder
    {
        ...
        /// <param name="matchExtensions">List of maximum Duplicated matches</param>
        ...
        /// <summary>
        /// Removes the duplicate and overlapping maximal Duplicated matches.
        /// </summary>
        ...
        /// </summary>
        /// <param name="matchIndex">Index of the maximal Duplicated match in UnionFind</param>
