...
namespace Bio.Algorithms.Alignment
{
    ...
    public class NUCmer
    {
        ...
        /// <param name="isDuplicatedInReference">flag to indicate that the matches should be Duplicated in reference.</param>
        /// <param name="isReversed">True if the query sequence is a reverse-complement</param>
        /// <returns>Returns clusters.</returns>
        public IList<Cluster> GetClusters(ISequence querySequence, bool isDuplicatedInReference = true, bool isReversed = false)
        {
            ...
            var internalMumList = GetMumList(querySequence, isDuplicatedInReference);
        ...
        /// </summary>
        /// <param name="querySequence">Query Sequence</param>
        /// <param name="isDuplicatedInReference">Whether MUMs are Duplicated in query or not.</param>
        /// <param name="isReversed">True if the query sequence is a reverse-complement</param>
        /// <returns>List of enumerable of delta alignments.</returns>
        public IEnumerable<DeltaAlignment> GetDeltaAlignments(ISequence querySequence, bool isDuplicatedInReference = true, bool isReversed = false)
        {
            IList<Cluster> internalClusterList = GetClusters(querySequence, isDuplicatedInReference, isReversed);
        ...
        private List<MatchExtension> GetMumList(ISequence querySequence, bool isDuplicatedInReference)
        {
            if (1 > LengthOfMUM)
            {
            ...
            IEnumerable<Match> matches = isDuplicatedInReference
                ? _internalMummer.GetMatchesDuplicatedInReference(querySequence)
