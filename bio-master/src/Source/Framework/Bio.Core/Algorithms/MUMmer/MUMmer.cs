...
namespace Bio.Algorithms.MUMmer
{
    ...
    public class MUMmer
    {
        ...
        /// This method does not considers Duplicatedness.
        /// </summary>
        ...
        public IEnumerable<Match> GetMatches(ISequence querySequence)
        {
            ...
            // Get matches from the suffix tree with out considering the Duplicatedness.
            return this.suffixTree.SearchMatches(querySequence);
        }

        /// <summary>
        /// Gets the maximum Duplicated matches in reference sequence.
        /// </summary>
        /// <param name="querySequence">Query sequence.</param>
        /// <returns>Returns IEnumerable of MUMs.</returns>
        public IEnumerable<Match> GetMatchesDuplicatedInReference(ISequence querySequence)
        {
            // Set the required properties of suffix tree.
            this.suffixTree.MinLengthOfMatch = this.LengthOfMUM;
            this.suffixTree.NoAmbiguity = this.NoAmbiguity;

            // Get matches that are Duplicated in reference sequence from the suffix tree. 
